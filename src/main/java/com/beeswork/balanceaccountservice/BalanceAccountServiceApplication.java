...
// TODO			18. schedule a function to update swipe_count because if you allow swipe() to plus swipe_count, then the number will be incorrect
// TODO			if multiple transaction tries to update the same entity. Version should slow down swipe() when many people try to update
...
// TODO			31. account_question should have history, because a user has answers on old question and try to click and should have history to match
// TODO			so, while balanceGame retrieves only the questions currently selected
